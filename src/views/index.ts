...
> = {
  ...
  document_api: () => import('./document/api/index.vue'),
  'document_feishu-link': () => import('./document/feishu-link/index.vue'),
  ...
  management_preview: () => import('./management/preview/index.vue'),
  management_report: () => import('./management/report/index.vue'),
